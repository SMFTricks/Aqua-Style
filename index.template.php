...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
	...
	if ($context['user']['is_logged'])
	{
		if (!empty($context['user']['avatar']))
			...
			echo '
				<img class="avatar" src="', $settings['images_url'], '/no_avatar.png" alt="" />';
		echo '
				<ul class="reset">
	...
	echo !empty($settings['forum_width']) ? '
		<div id="wrappercontent" style="width: ' . $settings['forum_width'] . '">' : '', '';
...
function aqua_copy()
{
	$AQUA = 'Theme by <a href="https://smftricks.com">SMF Tricks</a>';
